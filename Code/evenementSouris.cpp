...
{	
	...
	{	
		...
		if(emplacementSourisX < 1550 && emplacementSourisX > 620 && emplacementSourisY < 900 && emplacementSourisY > 520)
		{
			resultat = 100;
	...
	{					
		...
		if(toucheClavierSelectionnee != 36 && toucheClavierSelectionnee != 45 && toucheClavierSelectionnee!= 54 && toucheClavierSelectionnee!= 63)
		{
			...
			echangeTemp = "Lock ";
			ostringstream oss;
			oss<<(toucheClavierSelectionnee - 36);
			lettreETchiffre = oss.str();
			echangeTemp = echangeTemp + lettreETchiffre;
